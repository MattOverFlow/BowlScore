    ...
    <div class="container-fluid p-0 overflow-x-hidden overflow-y-auto" id="body_container">
        ...
        <div class="col-12 d-flex justify-content-center mt-4">
            <div class="col-9 d-flex flex-column justify-content-center align-items-center mb-3">
                <label for="searchInput" class="visually-hidden">Cerca team:</label>
                <input class="input-grey-rounded form-control" type="text" id="searchInput" placeholder="Cerca team...">
            </div>
        </div>
...
<script src="../../JAVASCRIPT/adminProfile/manageTeams.js"></script>
</html>
